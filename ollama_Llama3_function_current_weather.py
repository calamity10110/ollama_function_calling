...
response, messages = run_conversation(" Give a short answer. what is the weather in Vernon, BC, Canada?")
print(messages)
print(response)


# Tryes for model="llama3.1:latest"
# Only last prompt works correctly. " Give a short answer. what is the weather in Vernon, BC, Canada?"
